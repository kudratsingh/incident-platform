...
| `NULL` | Nothing has classified this failure, and the text must not invite a replay | worker exited without recording an outcome; also a bad CSV row nobody has triaged |
